...
# Использование списка задач в переменной вне функции (читаемость вывода страдает)
tasks_to_try = (
    Task('sleep', done=True),
    Task('wake', 'brian'),
    Task('wake', 'brian'),
...
# Можно использовать параметр ids в parametrize, чтобы описать предыдущий вывод (тест 4)
